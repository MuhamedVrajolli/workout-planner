...
INSERT INTO "user" (username, first_name, last_name, age, gender, weight, height) VALUES
                                                                                      ('john_doe', 'John', 'Doe', 28, true, 80, 180),
                                                                                      ('jane_smith', 'Jane', 'Smith', 32, false, 65, 170);

-- Muscle Table Insertions
INSERT INTO muscle (name, description, latin_name, type) VALUES
                                                             ('Biceps', 'Front part of the upper arm', 'Musculus biceps brachii', 'PULL'),
...
INSERT INTO exercise (name, description, file_url, type) VALUES
                                                             ('Shoulder Press', 'Exercise targeting the shoulder muscles', 'url_to_shoulder_press', 'WEIGHT'),
...
INSERT INTO exercise_muscle (muscle_id, exercise_id, effect) VALUES
                                                                 (3, 1, 'PRIMARY'),  -- Shoulder Press -> Front Shoulders
...
INSERT INTO workout_plan (name, description, author_id, category, published) VALUES
    ('PPL', 'Push, Pull, Legs split workout plan', 1, 'INTERMEDIATE', true);

-- Workout Day Table Insertions
INSERT INTO workout_day (day_name, day_of_week, plan_id) VALUES
                                                             ('Push', 1, 1),  -- Monday
                                                             ('Pull', 3, 1),  -- Wednesday
                                                             ('Legs', 5, 1);  -- Friday
...
INSERT INTO day_exercise (workout_day_id, exercise_id, sets, reps, until_failure, minutes) VALUES
                                                                                               (1, 1, 4, ARRAY[8, 8, 8, 8], false, 0),   -- Shoulder Press
...
INSERT INTO day_exercise (workout_day_id, exercise_id, sets, reps, until_failure, minutes) VALUES
                                                                                               (2, 4, 4, ARRAY[6, 6, 6, 6], false, 0), -- Chin-ups
...
INSERT INTO day_exercise (workout_day_id, exercise_id, sets, reps, until_failure, minutes) VALUES
                                                                                               (3, 6, 4, ARRAY[8, 8, 8, 8], false, 0), -- Barbell Back Squat
